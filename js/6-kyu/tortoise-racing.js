...
More generally: given two speeds v1 (A's speed, integer > 0) and v2 (B's speed, integer > 0) and a lead g (integer > 0) how long will it
take B to catch A?
...
*/
function tortoiseRace(v1, v2, g) {
    let speedDifference = v2 -v1;
    let catchTime = g / speedDifference;

    let totalSeconds = catchTime * 3600;
