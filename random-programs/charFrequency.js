...
class Default extends Map{
    constructor(defaultValue) {
        super();  // Invoke superclass constrcutor

        this.defaultValue = defaultValue; // Remember the deault value
    }
...
class Histogram{
    ...
    add(text){
        ...
        // Now to loop through the characters of the text
...
// This async (Promise-returning) function creates a Histogramobject,
// asynchronously reads chunks of text from standard input, and    adds those chunks to
// the histogram. When it reaches the end of the stream, itreturns this histogram
...
// It makes a Histogram object from standard input, then printsthe histogram.
